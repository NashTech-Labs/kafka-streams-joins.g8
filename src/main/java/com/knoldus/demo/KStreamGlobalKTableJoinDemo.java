...
import com.knoldus.demo.streams.KStreamGlobalKTableJoin;
import com.typesafe.config.Config;
import com.typesafe.config.ConfigFactory;
import org.apache.kafka.streams.KafkaStreams;

public class KStreamGlobalKTableJoinDemo {
    ...
    public static void main(String[] args) {
        KStreamGlobalKTableJoin streamJoin = new KStreamGlobalKTableJoin();
